...
echo "<h1 style=\"text-align:center;\">Abortion Dialogue</h1>";
...
$sql = "SELECT id, username, created_at, text, likes, reply FROM od_tweet WHERE topic='Abortion' ORDER BY id DESC";
            ...
            if ($reply != "n"){
                ...
                if (isset($_POST[$id])){
                    echo "<form action='http://127.0.0.1:3338/blm.php' method=\"post\" style='position:relative; left:30px;'>
                                      ...
                                      <input type=\"hidden\" name=\"topic\" value=\"Abortion\">
                                      <input type=\"hidden\" name=\"id\" value='$id'/>
